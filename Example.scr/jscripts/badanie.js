...
function arrangeOrdQsTab () {
  ...
  //for (i = 0; i < ordQsTab.length; i++) window.console.log("," + ordQsTab[i]);
...
function loadQuestsElements () {
  ...
  var rM_rN_Tab = [["rMNnazwa1", "rMNNazwa1"],
                   ["rMNnazwa2", "rMNNazwa2"],
                   ["rMNnazwa3", "rMNNazwa3"],
                   ["rMNnazwa4", "rMNNazwa4"],
                   ["rMNnazwa5", "rMNNazwa5"],
  ...
  var selObj = document.getElementById("rM"),
      optObj;
  while (selObj.length) {
...
function prepareQuest_rN (qId, fldName) {
  var field = document.questForm[fldName];
  var master = document.questForm.rM;
  var i;
